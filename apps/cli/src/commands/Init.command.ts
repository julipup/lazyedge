...
export const InitCommand = new Command()
  ...
  .action(async () => {
    ...
    logger.success(
      `${
        doConfigExists
          ? "Lazyedge config recreated"
          : "New lazyedge config created"
      }`
    );
  });
